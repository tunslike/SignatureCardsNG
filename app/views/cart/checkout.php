...
<div class="inner-header-checkout">
    <div class="inner-sub-body-checkout">
        ...
        <div>
        <a class="account-checkout" style="color:#fff;" href="<?php echo URLROOT; ?>cards/cart" title="View Cart!">Cart<img src="<?php echo URLROOT; ?>/public/img/cart_icon.png" /> <span class="cart-count-checkout" id="cardItem"><?php if(isset($_SESSION['cartItem'])) { echo count($_SESSION['cartItem']);} else {echo '0';} ?></span></a>
        </div>
    </div>
</div>
...
<div class="checkout-body">
    ...
    <div class="discount-code">
        <input type="text" placeholder="Enter discount here" name="discount_value" id="discount_value">
        <input type="button" value="Apply">
    </div>

    <div class="total-display">
        <div class="total-detail">
            <h3 style="font-weight:500;">Subtotal</h3>
            <h1 style="font-weight:500; font-size:1rem;">₦<?php echo number_format($sumAmount,2); ?></h1>
        </div>
        <div class="total-detail" style="margin-top: -10px;">
            <h3 style="font-weight:500;">Shipping</h3>
            <h1 style="font-weight:500; font-size:1rem;">₦<?php echo number_format($data['shipping'],2); ?></h1>
        </div>
