                ...
                <tr>
                    ...
                    <td valign="top" width="20%" align="left">
                        <div class="quantity-counter-cart">
                            <!--
                            <span style="display:none;" id="minusCounter" onClick="quantityCount('minus');" class="counter">-</span>-->
                            <span id="data_counter" data-counter="1" class="reader"><?php echo $item->QUANTITY; ?></span>
                            <!--<span style="display:none;" id="addCounter" onClick="quantityCount('add');" class="counter">+</span>-->
                        </div>
